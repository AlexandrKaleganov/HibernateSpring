...
insert into users(name, login, role_id, password) values('root', 'root', 1, 'root');
...
insert into marka(name) values ('Toyota'),('Nissan'),('Honda');
...
insert into model(name, marka_id) values
                                         ('RAV', 1),
                                         ('Corolla', 1),
                                         ('Corolla Runx', 1),
                                         ('Corolla Alex', 1),
